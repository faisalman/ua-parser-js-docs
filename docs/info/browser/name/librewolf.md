...
- **Developer:** The LibreWolf Community
...
LibreWolf is a privacy-focused fork of Firefox.
...
const ua = 'Mozilla/5.0 (X11; Linux x86_64; rv:97.0) Gecko/20100101 Firefox/97.0 LibreWolf/97.0.1';

const browser = parser.setUA(ua).getBrowser();

console.log(browser);
// {name: "LibreWolf", version: "97.0.1", major: "97"}

console.log(browser.is(BrowserName.LIBREWOLF));
// true
```
